...
TRAIN_PATH = $(DATA_PATH)train_without$1_$2.txt
TEST_PATH = $(DATA_PATH)pat$1_$2.txt
DIR = data/vision/polina/projects/cardiac/courtney/Sherwood-ckguo/cpp

$QR_PATH bin/linux/sw regression $TRAIN_PATH $TEST_PATH $DIR pat$1_$2 /P $1 /T $3 /D $4 /verbose